package com.example.cysandroidapp.AdsBlock.vpn;
...
public class MainVpnService extends VpnService {
    ...
    //TODO
        prefs = this.getApplicationContext().getSharedPreferences("com.example.cysandroidapp", Context.MODE_PRIVATE);
        gson = new Gson();
            ...
            public void run() {
                try {
                    ...
                    builder.setSession("BlockThisLocalVpn")
                            ...
                            .addDnsServer("76.76.19.19")
                            .addDnsServer("76.223.122.150");
                    ...
                    if (Build.VERSION.SDK_INT>=21) {
                        ...
                        if (!packages.contains("com.android.vending")) {
                            //TODO
                            builder.addDisallowedApplication("com.example.cysandroidapp");
                        }
                    }
