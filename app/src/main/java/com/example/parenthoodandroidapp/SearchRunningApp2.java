...
public class SearchRunningApp2 extends AccessibilityService {
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (!app_state) {
            ...
            Log.e("CheckStatus1","Current Time="+curTime);
            ...
            for (String pack_name : strings) {
                if (runningPackName.contains(pack_name)) {
                    if (isPerm.get(i) == 1) {
                        Log.e("CheckStatus2","Permanent App Block");
                        blockApp();
                    } else {
                        ...
                        Log.e("CheckStatus3","CurrentTime="+currentTime+"\n"+"Not Permanent "+"\nStart Time="+startTime+"="+startHour+":"+startMinute+"\nEndA Time="+endTime+"="+endHour+":"+endMinute);
